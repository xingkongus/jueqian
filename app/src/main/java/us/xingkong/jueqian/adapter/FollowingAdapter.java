...
public class FollowingAdapter extends RecyclerView.Adapter<FollowingAdapter.MyViewHolder> implements View.OnLongClickListener {
    ...
    public FollowingAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new FollowingAdapter.MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_mycollection, parent, false));
    }

    @Override
    public void onBindViewHolder(FollowingAdapter.MyViewHolder holder, final int position) {
//        holder.tv_questiontitle.setText(followings.get(position).getMtitle());

        holder.layout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String questionID;
                questionID = followings.get(position).getObjectId();
                ...
                new MaterialDialog.Builder(view.getContext())
                        ...
                        .onPositive(new MaterialDialog.SingleButtonCallback() {
                            ...
                            public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                                ...
                                question.setObjectId(followings.get(position).getObjectId());
                                ...
                                user.update(JueQianAPP.getAppContext(), new UpdateListener() {
                                    ...
                                    public void onSuccess() {
                                        ...
                                        notifyItemRangeChanged(position, followings.size());
