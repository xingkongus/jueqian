...
public class FollowerPresenter extends BasePresenterImpl implements FollowerContract.Presenter {
    private final FollowerContract.View mView;
    static List<Question> questions;
    private Handler mHandler;

    public FollowerPresenter(FollowerContract.View mView, Handler mHandler) {
        this.mView = mView;
